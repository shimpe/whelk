...
def write_text(path, text):
    # Always write LF line endings so generated files are identical on
    # Windows and Linux. This avoids Python's text-mode CRLF translation,
    # which - combined with CRLF-checked-out templates - produced doubled
    # carriage returns ("\r\r\n") on Windows.
...
def main():
    ...
    for input_file_path in input_files:
        ...
        write_text(path_to_output_file, schelp_template.render(data=parsed_toml))
        ...
        if 'doctests' in parsed_toml:
            ...
            try:
                ...
                for filename in parsed_toml['doctests']:
                    ...
                    write_text(path_to_output_file, doctest_template.render(data=parsed_toml, keyname=filename, classname=new_filename))
            ...
            if all_classnames: # at least one test was generated -> generate a file to run all these generated tests
                ...
                write_text(path_to_output_file, runall_template.render(classnames=all_classnames))
